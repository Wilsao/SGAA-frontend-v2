...
const routes = [
...

  {
    path: '/admin',
    children: [
      { path: 'dashboard', name: 'Dashboard', element: <DashboardMain />, roles: ['1'] },
      { path: 'usuarios', name: 'Lista de Usuarios', element: <UsuarioMain />, roles: ['1'] },
      { path: 'usuario/novo', name: 'Cadastro de Usuário', element: <UsuarioForm />, roles: ['1'] },
      { path: 'usuario/editar/:id', name: 'Editar Usuário', element: <UsuarioForm />, roles: ['1'] },
      { path: 'animais', name: 'Lista de Animais', element: <AnimalMain />, roles: ['1'] },
      { path: 'animal/novo', name: 'Cadastro de Animais', element: <AnimalForm />, roles: ['1'] },
      { path: 'animal/editar/:id', name: 'Editar Animal', element: <AnimalForm />, roles: ['1'] },
      { path: 'animal/:id/prontuario', name: 'Editar Animal', element: <AnimalProntuario />, roles: ['1'] },
      { path: 'arrecadacoes', name: 'Eventos de Arrecadação', element: <ArrecadacaoMain />, roles: ['1'] },
      { path: 'arrecadacao/novo', name: 'Cadastrar Evento de Arrecadação', element: <ArrecadacaoForm />, roles: ['1'] },
      { path: 'arrecadacao/editar/:id', name: 'Editar Evento de Arrecadação', element: <ArrecadacaoForm />, roles: ['1'] },
      { path: 'castracoes', name: 'Eventos de Castração', element: <CastracaoMain />, roles: ['1'] },
      { path: 'castracao/novo', name: 'Cadastrar Evento de Castração', element: <CastracaoForm />, roles: ['1'] },
      { path: 'castracao/editar/:id', name: 'Editar Evento de Castração', element: <CastracaoForm />, roles: ['1'] },
      // { path: 'castracao/novo', name: 'Cadastrar Evento de Castração', element: <CastracaoCreate />, roles: ['1'] },
      // { path: 'castracao/editar/:id', name: 'Editar Evento de Castração', element: <CastracaoEdit />, roles: ['1'] },
      { path: 'especies', name: 'Lista de Espécies', element: <EspecieMain />, roles: ['1'] },
      { path: 'especie/novo', name: 'Cadastro de Espécie', element: <EspecieForm />, roles: ['1'] },
      { path: 'especie/editar/:id', name: 'Editar Espécie', element: <EspecieForm />, roles: ['1'] },
